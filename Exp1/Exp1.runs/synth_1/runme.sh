...
HD_PWD='C:/Users/linnh/LabAD/Exp1/Exp1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_package_decoder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_package_decoder_wrapper.tcl
