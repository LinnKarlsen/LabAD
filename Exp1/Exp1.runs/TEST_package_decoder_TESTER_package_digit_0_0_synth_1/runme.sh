...
HD_PWD='C:/Users/linnh/LabAD/Exp1/Exp1.runs/TEST_package_decoder_TESTER_package_digit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_package_decoder_TESTER_package_digit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_package_decoder_TESTER_package_digit_0_0.tcl
