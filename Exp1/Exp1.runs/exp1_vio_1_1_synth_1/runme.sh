...
HD_PWD='C:/Users/linnh/LabAD/Exp1/Exp1.runs/exp1_vio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp1_vio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp1_vio_1_1.tcl
