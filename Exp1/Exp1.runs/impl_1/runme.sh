...
HD_PWD='C:/Users/linnh/LabAD/Exp1/Exp1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_package_decoder_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TEST_package_decoder_wrapper.tcl -notrace
